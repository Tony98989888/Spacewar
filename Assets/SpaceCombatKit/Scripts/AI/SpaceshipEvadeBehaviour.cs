...
namespace VSX.UniversalVehicleCombat
{
    public class SpaceshipEvadeBehaviour : AISpaceshipBehaviour
    {
        ...
        public virtual void UpdateEvadeDirection()
        {
            ...
            Debug.DrawLine(vehicle.transform.position, vehicle.transform.position + evadeDirection * 100, Color.blue);


            evadeDirection = Vector3.Slerp(evadeDirection, -toTargetDirection, turnAwayFromTarget);
            Debug.DrawLine(vehicle.transform.position, vehicle.transform.position + evadeDirection * 100, Color.cyan);
            ...
            Debug.DrawLine(vehicle.transform.position, vehicle.transform.position + evadeDirection * 100, Color.green);
            ...
            Debug.DrawLine(vehicle.transform.position, vehicle.transform.position + evadeDirection * 100, Color.yellow);
